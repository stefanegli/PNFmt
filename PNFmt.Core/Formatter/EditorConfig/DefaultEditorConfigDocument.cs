        ...
        private static readonly IReadOnlyList<DefaultSection> Sections =
            new[]
            {
                new DefaultSection(
                    ...
                    new DefaultSetting(EditorConfigSettingNames.Enabled, "true"),
                    new DefaultSetting(EditorConfigSettingNames.Format, "true"),
                ...
                new DefaultSection(
                    ...
                    new DefaultSetting(EditorConfigSettingNames.ResxInsertDocumentationComment, "false"),
                    new DefaultSetting(EditorConfigSettingNames.ResxInsertXsdSchema, "false"),

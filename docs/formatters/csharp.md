...
Generated files outside the normally excluded directories are treated like other `.cs` files. Disable their formatting with a more specific EditorConfig section, for example:

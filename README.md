...
| [`.resx`](docs/formatters/resx.md) | Resource | Stable | Sorts resource entries, protects runtime string newlines from Git checkout conversion, and optionally removes generated schema and documentation content. |
